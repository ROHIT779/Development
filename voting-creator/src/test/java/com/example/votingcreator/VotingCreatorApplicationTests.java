...
class VotingCreatorApplicationTests {
  ...
  void testCreatorSuccessfulWorkflow() throws URISyntaxException {
    ...
    Creator creatorReply =
        this.restTemplate.postForObject(
            new URI("http://localhost:" + port + "/service/creators/"), creator, Creator.class);
    ...
    Creator creatorGetReply =
        this.restTemplate.getForObject(
            new URI(
                "http://localhost:" + port + "/service/creators/" + creatorReply.getCreatorId()),
            Creator.class);
    ...
    assertThat(nominationReply.getCandidateList().get(0).getCandidateName())
        .isEqualTo(candidate1.getCandidateName());
    assertThat(nominationReply.getCandidateList().get(0).getCandidateInfo())
        .isEqualTo(candidate1.getCandidateInfo());
    assertThat(nominationReply.getCandidateList().get(1).getCandidateName())
        .isEqualTo(candidate2.getCandidateName());
    assertThat(nominationReply.getCandidateList().get(1).getCandidateInfo())
        .isEqualTo(candidate2.getCandidateInfo());

    Nomination nominationGetReply =
        this.restTemplate.getForObject(
            new URI(
                "http://localhost:"
                    + port
    ...
    assertThat(nominationGetReply.getCandidateList().get(0).getCandidateName())
        .isEqualTo(candidate1.getCandidateName());
    assertThat(nominationGetReply.getCandidateList().get(0).getCandidateInfo())
        .isEqualTo(candidate1.getCandidateInfo());
    assertThat(nominationGetReply.getCandidateList().get(1).getCandidateName())
        .isEqualTo(candidate2.getCandidateName());
  ...
  void testInvalidCreatorIdBadRequest() throws URISyntaxException {
    ...
    assertThatThrownBy(
            () ->
                this.restTemplate.getForObject(
                    new URI("http://localhost:" + port + "/service/creators/1234"), Creator.class))
  ...
  void testValidCreatorIdInvalidExistingEventIdBadRequest() throws URISyntaxException {
    ...
    Creator creator1Reply =
        this.restTemplate.postForObject(
            new URI("http://localhost:" + port + "/service/creators/"), creator1, Creator.class);
    ...
    Creator creator2Reply =
        this.restTemplate.postForObject(
            new URI("http://localhost:" + port + "/service/creators/"), creator2, Creator.class);
                ...
                this.restTemplate.getForObject(
                    new URI(
                        "http://localhost:"
                            ...
                            + creator1Reply.getCreatorId()
                            + "/events/"
                            + event2Reply.getEventId()),
                    Event.class))
        .isInstanceOf(HttpClientErrorException.BadRequest.class);
  }

  @Test
  void testValidCreatorIdInvalidExistingEventIdCreateNominationBadRequest()
  ...
  @Test
  void testValidCreatorIdInvalidExistingEventIdFetchNominationBadRequest()
      throws URISyntaxException {
    Creator creator1 = new Creator();
    creator1.setCreatorName("creator 1");
    creator1.setCreatorInfo("The first creator");
