...
All developed projects of Rohit Chakraborty (ROHIT779)

**1) Voting web service**

   <div>
   <div>
   <p><b>Goal:</b> Use Spring Boot and PostgreSQL and implement a Voting Service Application.</p> 
   ...
   <ol>
   <li><b>voting-creator:</b> A service to help admin/creator to create a voting event. Also it can be used to add candidates for the event.</li> 
   ...
   <li><b>voting-service:</b> This service will create a final report of voting results.</li>
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/creators/{creator_id}<br>
   </div>
   ...
   <div>
   Sample Request:<br>
   URI: POST /service/creators/{creator_id}/events<br>
   Headers:<br>
   Content-Type: application/json<br>
   Request Body:<br>
   <pre>
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/creators/{creator_id}/events/{event_id}<br>
   </div>
   ...
   <div>
   Sample Request:<br>
   URI: POST /service/creators/{creator_id}/events/{event_id}/nominations<br>
   Headers:<br>
   Content-Type: application/json<br>
   Request Body:<br>
   <pre>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/creators/{creator_id}/events/{event_id}/nominations<br>
   </div>
   ...
   <pre>
 {
   ...
   <div>
   Sample Request:<br>
   URI: POST /service/events/{event_id}/voters/<br>
   Headers:<br>
   Content-Type: application/json<br>
   Request Body:<br>
   <pre>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/events/{event_id}/voters/{voter_id}<br>
   </div>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/events/{event_id}/<br>
   </div>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: POST /service/events/{event_id}/voters/{voter_id}/vote<br>
   Headers:<br>
   Content-Type: application/json<br>
   Request Body:<br>
   <pre>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/voting/events/{event_id}<br>
   </div>
   ...
   <pre>
{
   ...
   <div>
   Sample Request:<br>
   URI: GET /service/voting/events/{event_id}/result<br>
   </div>
