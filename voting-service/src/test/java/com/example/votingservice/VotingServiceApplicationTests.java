...
class VotingServiceApplicationTests {
  ...
  @Autowired TestJDBCManager jdbcManager;
  ...
  private int createVoter(Connection connection, String voterId, String voterName, String eventId)
      throws SQLException {
    int rowsAffected = 0;
  ...
  private void castVote(Connection connection, String voterId, String eventId, String candidateId)
      throws SQLException {
