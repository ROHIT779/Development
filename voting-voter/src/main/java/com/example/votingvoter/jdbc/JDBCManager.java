...
public class JDBCManager {
    ...
    private Voter acknowledgeVoter(Connection connection, PreparedStatement statement, String voterId, String eventId, Vote vote) {
    ...
    public boolean validateId(String eventId, String voterId, String candidateId){
        ...
        try {
            ...
            if(eventId!=null && voterId==null && candidateId==null){
                ...
                resultSet = validateEventIdWithCandidateId(connection, statement, resultSet, eventId, candidateId);
                while (resultSet.next()) {
                    count = resultSet.getInt(1);
                }
                System.out.println("Count: "+count);
    ...
    private ResultSet validateEventId(Connection connection, PreparedStatement statement, ResultSet resultSet, String eventId){
    ...
    private ResultSet validateEventIdWithVoterId(Connection connection, PreparedStatement statement, ResultSet resultSet, String eventId, String voterId){
    ...
    private ResultSet validateEventIdWithCandidateId(Connection connection, PreparedStatement statement, ResultSet resultSet, String eventId, String candidateId){
    ...
    private boolean hasVoted(Connection connection, PreparedStatement statement, ResultSet resultSet, String voterId){
    ...
    private ResultSet getCountForCandidate(Connection connection, PreparedStatement statement, ResultSet resultSet, Vote vote, String eventId){
        try{
    ...
    private void addFirstVoteForCandidate(Connection connection, PreparedStatement statement, Vote vote, String eventId){
    ...
    private void addVoteForCandidate(Connection connection, PreparedStatement statement, ResultSet resultSet, Vote vote, String eventId){
        try{
